                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 " name="country" style="width: 100%;"
                                                ...
                                                <option value="{{ $customer->country }}" disabled >{{ $customer->country }}</option>
                                        ...
                                        <div class="form-group d-flex">
                                            <div class="form-check mr-3">
                                                <input class="form-check-input @error('gender') is-invalid @enderror"
                                                    type="radio" @if ($customer->gender == 'M') checked @endif name="gender" value="M" id="male">
                                                <label class="form-check-label" for="male">Male</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input @error('gender') is-invalid @enderror"
                                                    type="radio" name="gender" @if ($customer->gender == 'F')checked @endif value="F" id="female">
