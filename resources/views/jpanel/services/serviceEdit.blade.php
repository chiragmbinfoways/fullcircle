        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <!-- Default box -->
                    <!-- Profile Update box -->
                    <form action="{{ route('update.services',$service->id ) }}" method="post">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror " id="name"
                                                name="name" placeholder="Service Name" value="{{$service->name}}">
                                                @if ($errors->has('name'))
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('gst') is-invalid @enderror " id="gst"
                                                name="gst" placeholder="Enter Gst percentage" value="{{$service->gst}}">
                                                @if ($errors->has('gst'))
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm @error('time') is-invalid @enderror " id="time" placeholder="Enter Minutes" value="{{$service->time}}"  name="time">
