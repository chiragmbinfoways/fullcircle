                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('bname') is-invalid @enderror " id="bname"
                                                name="bname" placeholder="Branch Name" value="{{$branch->name}}">
                                                @if ($errors->has('bname'))
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('address') is-invalid @enderror " id="address"
                                                name="address" placeholder="Enter Address " value="{{$branch->address}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('city') is-invalid @enderror " id="city"
                                                name="city" placeholder="Enter City " value="{{$branch->city}}">
                                                @if ($errors->has('city'))
                                     ...
                                     <div class="col-md-4 d-none">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('zipcode') is-invalid @enderror " id="zipcode"
                                                name="zipcode" placeholder="Enter Zipcode " max="7" value="{{$branch->pincode}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            name="number" placeholder="Enter Contact Number" max="10" value="{{$branch->number}}">
