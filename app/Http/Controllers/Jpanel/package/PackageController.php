...
class PackageController extends Controller
{
    ...
    public function create()
    {
        ...
        if ($hasPermission) {
            ...
            return view('jpanel.package.packageAdd', compact('services') );
        } 
        else {
            abort(403);
        }
    ...
    public function edit($id)
    {
        ...
        if ($hasPermission) {
            ...
            return view('jpanel.package.packageEdit', compact('package','services'));
        } else {
            abort(403);
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        $package = package::where('id', $request->id)->update(['name' => $request->pname,'service' => $request->service,'times' => $request->time, 'total'=>$request->total]);
        if ($package) {
